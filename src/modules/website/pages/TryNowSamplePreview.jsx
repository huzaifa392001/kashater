...
const TryNowSamplePreview = () => {
  return (
    <>
      <Header />

      <Navbar expand="xl" className="custom-navbar py-3">
        <Container>
          {/* Left: Logo */}
          <Navbar.Brand href="/">
            <img className="main-logo" src={logo} alt="KADHASTER" />
          ...
          <Navbar.Collapse id="navbar-nav" className="nav-bar min-nav">
            <Nav className="mx-auto">
              ...
              <NavLink to="/try-now" className="nav-link">
                Try Now
              </NavLink>
          ...
          <div className="res-view">
            <div className="nav-pro">
              {/* Right: Profile Icon */}
              <section className="profile-icon d-none">
                {/* empty profile */}
                <img
...
export default TryNowSamplePreview;
