                ...
                <div>
                  <div className="mb-3 try-flex-col">
                    ...
                    <div className="try-upload-card">
                      {file?.name ?
                        <img
                          className="subject-image " src={URL.createObjectURL(file)} alt="" role="button" onClick={() => { setOpenCropperPopup(true) }} /> :
                        <img
                          className="" src={upload_photo_ic} alt="" role="button" onClick={() => { setOpenCropperPopup(true) }} />}
              ...
              <section className={classes.preview}>
                ...
                <section>
                  ...
                  <button onClick={() => handleReset()} style={{ color: '#000' }}>
                    <img
                      src={retry_arrow} alt="" style={{ width: '20px', height: '20px' }} role="button" />retry
                  </button>
                </section>
              </section>
            ) : (
