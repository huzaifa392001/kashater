  ...
  const metrics = [
    {
      ...
      count: data?.processed?.total_count || 0,
      percent: data?.processed?.precent || 0,
      type: data?.processed?.type || "increased",
      img: imag1,
    },
    {
      key: "passed",
      title: "Orders Passed QC (%)",
      count: data?.passed?.total_count || 0,
      percent: data?.passed?.precent || 0,
      type: data?.passed?.type || "increased",
      img: imag2,
    },
    {
      key: "failed",
      title: "Orders Failed QC (%)",
      count: data?.failed?.total_count || 0,
      percent: data?.failed?.precent || 0,
      type: data?.failed?.type || "increased",
      img: imag3,
    },
  ]
