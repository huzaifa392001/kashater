...
import classes from "./ConfigureCharacterType.module.css"
...
const ConfigureCharacterType = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                deleteCategory(
                    {
                        method: "DELETE",
                        url: `admin/story-management/character-type/delete/${row?.id}`,
                    },
                    () => {
                        Swal.fire(
                            "Deleted!",
                            "Your Character Type has been deleted.",
                            "success"
                        ).then(() => {
    ...
    const handleSubmit = () => {
        if (type === "add") {
            addCategory(
                {
                    url: `admin/story-management/character-type/create`,
                    method: "POST",
                    body: {
                        name: name,
                    },
                ...
                () => {
                    setOpenAdduser(false)
                    Swal.fire("Added!", "Your Character Type has been added.", "success").then(
                        () => {
                            handleClearInput()
                            setlistsTrigger(prev => !prev)
                        }
            ...
            updateCategory(
                {
                    ...
                    url: `admin/story-management/character-type/update`,
                    method: "PUT",
                    body: {
                        name: name,
                        id: editCatID
                ...
                () => {
                    ...
                    Swal.fire(
                        "Updated!",
                        "Your Character Type has been updated.",
                        "success"
                    ).then(() => {
                        handleClearInput()
                        setlistsTrigger(prev => !prev)
    ...
    useEffect(() => {
        categoryLists(
            {
                url: `admin/story-management/character-type/list`,
                method: "POST",
                body: {
                    page: page,
                    per_page: perPage,
...
export default ConfigureCharacterType
