...
import classes from "./OrderReports.module.css"
...
const OrderReports = () => {
  ...
  const StoryListData = [
    ...
    },
    {
      ...
      cell: row => (
        <>
          <p className="">{row.order_number}</p>
        </>
      ),
      // maxWidth: "190px",
      // minWidth: "150px",
    ...
    },
    {
      ...
      cell: row => (
        <>
          <p className="">{row.delivered_date}</p>
        </>
      ),
  ...
  const onDownloadItemClick = fileType => {
    ...
    axios({
      method: "post",
      url: `${baseUrl}/admin/report-management/order/download`,
      data: {
        type: fileType,
        search: searchValue,
        filter: {
  ...
  const viewList = () => {
    sendRequest(
      {
        url: `admin/report-management/order/list`,
        method: "POST",
        body: {
          page: page,
          per_page: perPage,
  ...
  const apiBoxesData = () => {
    sendRequest(
      {
        url: `admin/report-management/order/count`,
      },
      data => {
        ...
        <div className={classes.header_table}>
          ...
          <div className={classes.header_table_box}>
            <div className={classes.header_table_left}>
              <p className={classes.header_titel}>{totalReporting} Order</p>
              {/* <Slecter
                data={
