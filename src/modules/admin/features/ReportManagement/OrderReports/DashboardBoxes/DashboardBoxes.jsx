...
const DashboardBoxes = ({ data }) => {
  const metrics = [
    ...
    },
    {
      ...
      count: data?.total_orders?.total_count || 0,
      percent: data?.total_orders?.precent || 0,
      type: data?.total_orders?.type || "increased",
      img: imag2,
    },
    {
      key: "delivered",
      title: "Total Orders Delivered",
      count: data?.total_orders_delivered?.total_count || 0,
      percent: data?.total_orders_delivered?.precent || 0,
      type: data?.total_orders_delivered?.type || "increased",
      img: imag3,
    },
    {
      key: "failed",
      title: "Total Orders Cancelled",
      count: data?.total_orders_cancelled?.total_count || 0,
      percent: data?.total_orders_cancelled?.precent || 0,
      type: data?.total_orders_cancelled?.type || "increased",
      img: imag3,
    },
  ]
