...
import classes from "./ConfigureCategory.module.css"
...
const ConfigureCategory = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        deleteCategory(
          {
            method: "DELETE",
            url: `admin/story-management/category/delete/${row?.id}`,
          },
          () => {
            Swal.fire(
              "Deleted!",
  ...
  const handleSubmit = () => {
    if (type === "add") {
      addCategory(
        {
          url: `admin/story-management/category/create`,
          method: "POST",
          body: {
            name: name,
          },
      ...
      updateCategory(
        {
          url: `admin/story-management/category/update/${editCatID}`,
          method: "PUT",
          body: {
            name: name,
          },
  ...
  useEffect(() => {
    categoryLists(
      {
        url: `admin/story-management/category/list`,
        method: "POST",
        body: {
          page: page,
          per_page: perPage,
